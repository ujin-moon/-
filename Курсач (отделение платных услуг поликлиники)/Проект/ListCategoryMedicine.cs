...
namespace Проект
{
    public partial class ListCategoryMedicine : Form
    {
        public ListCategoryMedicine()
        {
            InitializeComponent();
        }
        ...
        private void UpdateTable()
        {
            ...
            SqlCommand myCmd = new SqlCommand("PrintCategoryMedicine", SC);
        ...
        {
            AddCategoryMedicine f = new AddCategoryMedicine();
            f.ShowDialog();
            PoiskTextBox.Text = "";
            UpdateTable();
        }
        ...
        private void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (DeleteBool == true)
                {
                    var sqlCmd = new SqlCommand("DeleteCategoryMedicine", SC);
            ...
            catch (System.ArgumentOutOfRangeException)
            {
                ...
                FormError.TextError = "Таблица категорий лекарств пуста !";
                f.ShowDialog();
            }
            catch (System.Data.SqlClient.SqlException)
            {
                FormError f = new FormError();
                FormError.TextError = "Категория лекарства не может быть" + '\n' + "удалена, так как уже используется !";
                f.ShowDialog();
            }
        }
        ...
        {
            DataTable dt = new DataTable();
            SqlCommand myCmd = new SqlCommand("PoiskCategoryMedicine", SC);
            myCmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(myCmd);

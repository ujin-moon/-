...
namespace Проект
{
    public partial class ChooseDoctorСategory : MetroFramework.Forms.MetroForm
    {
        public ChooseDoctorСategory()
        {
            InitializeComponent();
        }
        ...
        private void UpdateTable()
        {
            ...
            SqlCommand myCmd = new SqlCommand("PrintDoctorCategory", SC);
        ...
        {
            DataTable dt = new DataTable();
            SqlCommand myCmd = new SqlCommand("PoiskDoctorCategory", SC);
            myCmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(myCmd);

...
namespace Проект
{
    public partial class ListDoctorCategory : Form
    {
        public ListDoctorCategory()
        {
            InitializeComponent();
        }
        ...
        private void UpdateTable()
        {
            ...
            SqlCommand myCmd = new SqlCommand("PrintDoctorCategory1", SC);
        ...
        {
            AddDoctorCategory f = new AddDoctorCategory();
            f.ShowDialog();
            PoiskTextBox.Text = "";
            UpdateTable();
        }
        ...
        private void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (DeleteBool == true)
                {
                    var sqlCmd = new SqlCommand("DeleteDoctorCategory", SC);
            ...
            catch (System.ArgumentOutOfRangeException)
            {
                ...
                FormError.TextError = "Таблица категорий врача пуста !";
                f.ShowDialog();
            }
            catch (System.Data.SqlClient.SqlException)
            {
                FormError f = new FormError();
                FormError.TextError = "Категория врача не может быть удалена," + '\n' + "так как уже используется !";
                f.ShowDialog();
            }
        }
        ...
        {
            DataTable dt = new DataTable();
            SqlCommand myCmd = new SqlCommand("PoiskDoctorCategory1", SC);
            myCmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(myCmd);

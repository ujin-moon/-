...
namespace Проект
{
    public partial class FormAdministrator : Form
    {
        ...
        private void MenuButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MenuButton5.Text = "Графики работы врачей";
                MenuPanel.Width = 248;
            }
        }
        ...
        private void MenuButton1_Click(object sender, EventArgs e)
        {
            ...
            AbrirFormEnPanel(new ListSpecialty());
        }
        ...
        private void MenuButton2_Click(object sender, EventArgs e)
        {
            ...
            MenuButton5.BackColor = Color.FromArgb(39, 57, 80);
            MenuButton6.BackColor = Color.FromArgb(39, 57, 80);
            AbrirFormEnPanel(new ListDoctorCategory());
        }
        ...
        private void MenuButton5_Click(object sender, EventArgs e)
        {
            ...
            MenuButton6.BackColor = Color.FromArgb(39, 57, 80);
            AbrirFormEnPanel(new ListDoctorWorkSchedule());
        }
        ...
        private void MenuButton6_Click(object sender, EventArgs e)
        {
            ...
            AbrirFormEnPanel(new ListServices());
        }

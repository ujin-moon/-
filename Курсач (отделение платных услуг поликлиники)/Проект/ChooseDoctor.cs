...
namespace Проект
{
    public partial class ChooseDoctor : MetroFramework.Forms.MetroForm
    {
        public ChooseDoctor()
        {
            InitializeComponent();
        ...
        private void UpdateTable()
        {
            ...
            SqlCommand myCmd = new SqlCommand("ChoiceDoctor", SC);
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Title = dtUniversal[2, indeks].Value.ToString();
                Close();
            }
            catch (System.ArgumentOutOfRangeException)
            {
                FormError f = new FormError();
                FormError.TextError = "Таблица врачей пуста !";
                f.ShowDialog();
            }
        }
        ...
        {
            DataTable dt = new DataTable();
            SqlCommand myCmd = new SqlCommand("PoiskDoctor", SC);
            myCmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(myCmd);
